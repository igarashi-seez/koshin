...
<?php for ($i = 1; $i < 13; $i++) { ?>
							<div class="item">
								<img src="./image/img<?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>.jpg" width="1000" height="560" decoding="async">
							</div>
<?php }; ?>
						</div>
...
?>
							<div class="item item<?php echo $i; ?> current">
								<span class="slideLink" data-slick="<?php echo $i; ?>">
									<img src="./image/thumb<?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>.jpg" width="160" height="100" decoding="async">
								</span>
							</div>
<?php } else { ?>
