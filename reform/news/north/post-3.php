...
//タイトル
$entry_title = "外壁塗り替えリフォームパック";

//フォーム処理
$event_name = "外壁塗り替えリフォームパック";//元のURL
			...
			<div class="no-gutters">
				<div class="col-lg-12 text">
					<div class="inner">
						...
						<div class="entry">
							<p><img alt="img02.jpg" src="http://www.mitsuihome-ksa.co.jp/reform/news/images/img02.jpg" width="1000" height="1358" class="mt-image-center" style="text-align: center; display: block; margin: 0 auto 20px;" /></p>
						</div>
